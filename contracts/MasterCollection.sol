...
contract MasterCollection is ERC1155Upgradeable, OwnableUpgradeable, UUPSUpgradeable {
        ...
        payable
    {
        ...
        emit NewVersoCreated(msg.sender, newTokenId, url);
    }
    ...
    function _executeBuy(uint256 tokenId) private {
        ...
        require(supply > 0 || creator[tokenId] == msg.sender, "Only the creator can buy the first token");
    ...
    function allowUpgradeFor(address _newImp) public onlyOwner() {
        _authorizeUpgrade(_newImp);
    }
